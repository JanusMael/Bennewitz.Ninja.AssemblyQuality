...
| Repository | `Bennewitz.Ninja.AssemblyQuality` |
...
```bash
git tag -a v2026.3.920 -m "Bennewitz.Ninja.AssemblyQuality 2026.3.920"
...
```bash
gh run watch --repo JanusMael/Bennewitz.Ninja.AssemblyQuality --exit-status
```
